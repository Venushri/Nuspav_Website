...
const Footer = () => (
  <footer className="w-full bg-gray-800 text-white pt-8 pb-4 px-4 mt-8">
    <div className="max-w-6xl mx-auto flex flex-col md:flex-row gap-8">
      ...
      {/* Navigation Links, Contact, Social - grouped and pushed right */}
      <div className="flex flex-1 justify-end gap-12">
        {/* Navigation Links */}
        <div className="flex flex-col items-start">
          <h4 className="font-semibold mb-2 text-left">Quick Links</h4>
        ...
        {/* Contact Info */}
        <div className="flex flex-col items-start">
          <h4 className="font-semibold mb-2 text-left">Contact</h4>
        ...
        {/* Social Links */}
        <div className="flex flex-col items-start">
          <h4 className="font-semibold mb-2 text-left">Follow Us</h4>
